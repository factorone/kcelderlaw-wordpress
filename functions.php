...
if (function_exists('add_theme_support')) 
{
    ...
    add_image_size('corp_blog_img',1180,500,true);
    add_image_size('home-featured-slider',255,255,true);
    ...
    if($args['search_title'] != '') 
    {
        ...
        <div class="t1_search_cont">
            <form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
                ...
                <input type="image" src="<?php bloginfo('stylesheet_directory'); ?>/images/search-icon.jpg" class="t1_search_icon" alt="Submit Form" />
